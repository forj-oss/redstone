...
class gerrit_config(
  ...
  #TODO while Jeepyb doesnt not has the revision paramter to download from github an specific version we need to install jeepyb_config
  ...
  file { '/home/gerrit2/review_site/etc/gerrit.config':
    ...
    group   => 'gerrit2',
    mode    => '0644',
    content => template('gerrit_config/gerrit.config.erb'),
    replace => true,
    require => File['/home/gerrit2/review_site/etc'],
  }
